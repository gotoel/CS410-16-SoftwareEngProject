...
<html lang="en">
<head>
<title>EDSN Calendar - Organize</title>
<meta charset="UTF-8" />
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="active"> <a href="organize.jsp"><i class="icon icon-tags"></i> <span>Organize</span></a> </li>
...
<!--breadcrumbs-->
  <div id="content-header">
        <div id="breadcrumb"> <a href="index.jsp" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Organize</a> </div>
    <h1>Organize</h1>
  </div>
<!--End-breadcrumbs-->
