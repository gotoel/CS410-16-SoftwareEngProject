...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-inbox"></i> Widgets</a>
  <ul>
    ...
    <li class="active"> <a href="widgets.jsp"><i class="icon icon-inbox"></i> <span>Widgets</span></a> </li>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-info-sign"></i> <span>Error</span> <span class="label label-important">4</span></a>
      <ul>
        <li><a href="error403.jsp">Error 403</a></li>
        <li><a href="error404.jsp">Error 404</a></li>
        <li><a href="error405.jsp">Error 405</a></li>
